...
- The trusted Antigravity workspace hook blocks collaboration tools before execution. The UI writer cannot edit the hook, rule, runner, or any other policy file; any observed subagent event also fails the post-run gate.
